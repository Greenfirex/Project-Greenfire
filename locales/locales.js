...
loaded['en'] = {
    ...
    "result_check_comms_v2": "You power up the station. Nothing but static. The panel is gone — just bare wires where the comms module should be. This isn't crash damage. You ripped it out. During your escape, you tore it from the console and threw it somewhere in the workshop so they couldn't track you. You give it a quick inspection: fried signal amplifier, missing power cell, bent connector. You'll need the fabricator for a new amplifier, a power cell, and proper tools. You should be able to find that in the workshop.",
