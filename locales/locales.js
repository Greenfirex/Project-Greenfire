...
loaded['en'] = {
  ...
  "popup_welcome_page1": "Darkness. Then a jolt — violent and sudden. Alarms scream through the corridors of your scout ship. The smell of burning electronics fills the air as emergency lights flicker to life.",
  "popup_welcome_page2": "You pull yourself upright in the crew quarters. Through the viewport, an unfamiliar planet looms large — pale amber atmosphere, strange cloud formations. This wasn't your destination.",
  "popup_welcome_page3": "Your name is Lieutenant Commander. Your scout ship is damaged but intact. Your crew is scattered. Mission parameters: unknown. But you are still breathing — and that means there is work to do.\\n\\nAssess the damage. Contact the surface team. Learn what brought you here. And above all: survive.",
