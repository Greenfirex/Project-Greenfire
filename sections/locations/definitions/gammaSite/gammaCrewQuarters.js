// ==========================================================================
// Location: Gamma Site — Crew Quarters (ground base location)
// ==========================================================================

export const gammaCrewQuarters = {
    id: 'gamma_crew_quarters',
    siteId: 'gamma_site',
    nameKey: 'loc_gamma_crew_quarters',
    image: 'assets/images/localmap/crewquarters.png',
    descriptionKey: 'loc_gamma_crew_quarters_desc',
    actions: [
        {
            id: 'search_bunks',
