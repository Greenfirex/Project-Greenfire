...
function animateFooterLatestChange(nextText, nextColor) {
    ...
    // Instant text — no typewriter (removed for mobile performance)
...
// Toasts are now handled by engine/ingameLog.js — single source of truth
// for log entries + toast creation via the shared mobile buffer.
...
function installLogObserver() {
    ...
    logObserver = new MutationObserver(() => {
        ...
        // Toasts now created by engine/ingameLog.js _flushBuffer()
    });
